...
class ItemsActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        handleDisplaySelection(viewModel.navDrawerDisplaySelction)
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_recent_notes -> {
                ...
                viewModel.navDrawerDisplaySelction = item.itemId
            }
            R.id.nav_share -> {
    ...
    private fun showHowMany() {
        val message = getString(R.string.nav_howmany_message_format,
